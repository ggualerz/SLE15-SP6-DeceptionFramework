...
configure_kernel() {
    ...
    echo "CONFIG_MODULE_SIG_UEFI=n" >> "$CONFIG_FILE"
    echo "CONFIG_SYSTEM_TRUSTED_KEYRING=n" >> "$CONFIG_FILE"
    echo "CONFIG_SYSTEM_TRUSTED_KEYS=n" >> "$CONFIG_FILE"
    echo "CONFIG_SECONDARY_TRUSTED_KEYRING=n" >> "$CONFIG_FILE"
    echo "CONFIG_SYSTEM_BLACKLIST_KEYRING=n" >> "$CONFIG_FILE"
    echo "CONFIG_SYSTEM_BLACKLIST_HASH_LIST=n" >> "$CONFIG_FILE"
    echo "CONFIG_IMA=n" >> "$CONFIG_FILE"
    echo "CONFIG_EVM=n" >> "$CONFIG_FILE"
    echo "CONFIG_DEFAULT_SECURITY_APPARMOR=n" >> "$CONFIG_FILE"
    echo "CONFIG_DEFAULT_SECURITY_SELINUX=n" >> "$CONFIG_FILE"
    echo "CONFIG_DEFAULT_SECURITY_TOMOYO=n" >> "$CONFIG_FILE"
